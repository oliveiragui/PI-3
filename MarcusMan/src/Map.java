...
public class Map
{
    ...
    public boolean checkCollision(Rectangle rect, int layer, int xZoom, int yZoom) {
        int tileWidth = 18 * xZoom;
        int tileHeight = 18 * yZoom;
    ...
    public void render(RenderHandler renderer, GameObject[] objects, int xZoom, int yZoom)
    {
        ...
        for(int layer = 0; layer < numLayers; layer++)
        {
            ...
            int leftBlockX = (topLeftX/tileWidth - blockStartX - 18)/blockWidth;
            int blockX = leftBlockX;
            int blockY = (topLeftY/tileHeight - blockStartY - 18)/blockHeight;
            int pixelX = topLeftX;
            int pixelY = topLeftY;
