...
public class Map
{
	 ...
	 *            path nodes.
	 */
	public void drawMap(Graphics g, List<Node> path, List<Node> path2, List<Node> pathEnemy)
	{
			...
			for (int x = 0; x < width; x++)
			{
				...
				else if (path != null && path.contains(new Node(x, y, true)))
				{
					g.setColor(Color.YELLOW);
                                ...
                                else if(path2 != null && path2.contains(new Node(x, y, true)))
                                {
                                        g.setColor(Color.CYAN);
                                }
                                else if(pathEnemy != null && pathEnemy.contains(new Node(x, y, true)))
                                {
