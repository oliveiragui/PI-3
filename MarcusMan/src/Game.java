...
public class Game extends JFrame implements Runnable
{
    ...
    public Game()
    {
        ...
        {
            Rectangle tileRectangle = new Rectangle(0, i*(18*xZoom + 2), 18*xZoom, 18*yZoom);
        ...
        enemy = new Enemy(playerAnimations, xZoom, yZoom);
        objects[0] = player;
        objects[1] = enemy;
        objects[2] = gui;
    ...
    public void leftClick(int x, int y)
    {
        ...
        if(!stoppedChecking)
        {
            x = (int) Math.floor((x + renderer.getCamera().x)/(18.0 * xZoom));
            y = (int) Math.floor((y + renderer.getCamera().y)/(18.0 * yZoom));
